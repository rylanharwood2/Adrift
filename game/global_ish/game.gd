...
var suicune_enemy_scene = preload("res://game/entities/creatures/enemies/suicune_enemy.tscn")
var capo_enemy_scene = preload("res://game/entities/creatures/enemies/capo_enemy.tscn")
var helheim_scene = preload("res://game/entities/creatures/enemies/helheim_king_of_slime.tscn")
var asteroid_scene = preload("res://game/entities/asteroids/asteroid.tscn")
var frozen_asteroid_scene = preload("res://game/entities/asteroids/frozen_asteroid.tscn")
